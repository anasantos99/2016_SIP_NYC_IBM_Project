...
function when() {
	if(document.getElementById("when").innerHTML == "When did this start?(uen did dis start?)"){
        document.getElementById("when").innerHTML = "";
    } else {
        document.getElementById("when").innerHTML = "When did this start?(uen did dis start?)";
    }
}
function at() {
...
function diet() {
	if(document.getElementById("diet").innerHTML == "What does your diet look like?(uat does your diet lok like?)"){
        document.getElementById("diet").innerHTML = "";
    } else {
        document.getElementById("diet").innerHTML = "What does your diet look like?(uat does your diet lok like?)";
    }
}
function exercise() {
	if(document.getElementById("exercise").innerHTML == "What is your exercise routine?(uat is your exercise rotine?)"){
        document.getElementById("exercise").innerHTML = "";
    } else {
        document.getElementById("exercise").innerHTML = "What is your exercise routine?(uat is your exercise rotine?)";
    }
}
